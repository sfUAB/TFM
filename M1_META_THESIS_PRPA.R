...
files_INMA <- list.files(path = "./data/INMA/results/phenols/model1", 
                         pattern = "PACE_phthalates_INMA_EWAS_Model(A|B|C)_(prpa)_mraw_(creat_total_log2)_.*", 
                         full.names = TRUE)
files_INMA #3

files_NELA <- list.files(path = "./data/NELA/results/phenols/model1", 
                         pattern = "PACE_phthalates_NELA_EWAS_Model(A|B|C)_(ad.*)_(PPB)(_media)?_S24_.*", 
                         full.names = TRUE)
files_NELA #3 files
...
output_dir <- "./data/renamed_files_forSFTHESIS_PRPA"
...
metafiles <- list(
  'Meta1A' = c('Model1A_INMA_PRPA', 
                'Model1A_NELA_PRPA' ),
  
  'Meta1B' = c('Model1B_INMA_PRPA', 'Model1B_NELA_PRPA'),
  
  'Meta1C' = c( 'Model1C_INMA_PRPA',
                'Model1C_NELA_PRPA'))
...
results_gwama <- 'metaanalysis/GWAMA_Results_Phenols_Sfraley_thesis/Model_1_PRPA'
