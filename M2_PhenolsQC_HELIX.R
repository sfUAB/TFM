...
setwd("Z:/analyses/ATH_EWAS_phenols/db/M2_persistenteffects_newimputation")
setwd("/PROJECTES/HELIX_OMICS/analyses/ATH_EWAS_phenols/db/M2_persistenteffects_newimputation")    #for mobaxterm
...
results_folder <- "QC_Results_Phenols_Sfraley_thesis/Model_2"

# Prefixes for each file 
prefixes <- c( 'Model2A_HELIX_BPA', 'Model2A_HELIX_PRPA', 'Model2A_HELIX_TRCS',
               'Model2B_HELIX_BPA', 'Model2B_HELIX_PRPA', 'Model2B_HELIX_TRCS',
               'Model2C_HELIX_BPA', 'Model2C_HELIX_PRPA', 'Model2C_HELIX_TRCS'
               )
...
# Array type, used : 
artype <- c('450K', '450K', '450K', '450K', '450K', '450K', '450K', '450K', '450K')
length(artype)
...
N <- c(841, 841, 841, 841, 841, 841, 841, 841, 841 #HELIX
)
length(N)
n <- c(NA)
...
patterns <- c("BPA", "PRPA", "TRCS")

#R
boxplot_folder <- "/PROJECTES/HELIX_OMICS/analyses/ATH_EWAS_phtalates/metaanalysis/QC_Results_Phenols_Sfraley_thesis/Model_2/Boxplots"
dir.create(boxplot_folder, showWarnings = FALSE)

setwd("/PROJECTES/HELIX_OMICS/analyses/ATH_EWAS_phtalates/metaanalysis/QC_Results_Phenols_Sfraley_thesis/Model_2/Boxplots")
...
for (pattern in patterns){
  ...
  if (length(grouped_data) > 0){
    #open png
    file_path <- file.path(boxplot_folder, paste("BoxplotsM2_", pattern, "_.png"))
...
#Mobaxterm
setwd("/PROJECTES/HELIX_OMICS/analyses/ATH_EWAS_phtalates/metaanalysis/QC_Results_Phenols_Sfraley_thesis/Model_2") 
precisionplots_folder <- "/PROJECTES/HELIX_OMICS/analyses/ATH_EWAS_phtalates/metaanalysis/QC_Results_Phenols_Sfraley_thesis/Model_2/Precision_Plots"
dir.create(precisionplots_folder, showWarnings = FALSE)
setwd("/PROJECTES/HELIX_OMICS/analyses/ATH_EWAS_phtalates/metaanalysis/QC_Results_Phenols_Sfraley_thesis/Model_2/Precision_Plots")
...
QC_sum_sorted_by_compound <- QC_sum_condensed[order(grepl("BPA$", QC_sum_condensed$prefixes), 
                                                    ...
                                                    grepl("TRCS$", QC_sum_condensed$prefixes),
...
library(writexl)
write_xlsx(QC_sum_sorted_by_compound, "QC_phenol_M2_excel_final.xlsx")
